...
public class FloorThreeEnemy : MonoBehaviour
{
    #region Varibles

    // List of variables needed (You probably don't need half of these)
    private Health _health;
    private readonly MonsterTypes.Floor3Monsters _type3 = new MonsterTypes.Floor3Monsters();
   ...
   [SerializeField] private SpriteRenderer _sprite;
    ...
    private void Start()
    {
        ...
        _mAgent.speed = MonsterTypes.Floor3Monsters.Speed;
    ...
    private void Update()
    {
        ...
        switch (_stunned)
        {
            case false:
            {
                ...
                if (_type3.PlayerInRange && _lineOfSight)
                {
    ...
    {
        _cooldown = true;
        _health.health -= MonsterTypes.Floor3Monsters.Damage;
        _stunned = true;
        hitAudioSource.Play();
